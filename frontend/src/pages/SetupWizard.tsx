...
type Step = 'department' | 'bulk-import' | 'years' | 'schedule' | 'sections' | 'subjects' | 'lab-batches' | 'electives' | 'teachers' | 'rooms' | 'constraints' | 'generate';

const steps: { id: Step; label: string; description: string }[] = [
  { id: 'department', label: 'Department', description: 'Choose the institution and department to configure' },
  ...
  { id: 'electives', label: 'Electives', description: 'Mark which elective options are offered' },
  ...
  { id: 'constraints', label: 'Constraints', description: 'Set priorities and use the AI assistant' },

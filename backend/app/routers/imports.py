...
SHEET_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    "AcademicYears": {
        "model": AcademicYear,
        "required": {"id", "name"},
        "columns": ["id", "name", "department_id", "num_sections", "lunch_start", "lunch_end"],
        "json": set(),
        "int": {"num_sections"},
    ...
    "Subjects": {
        ...
        "columns": [
            "id", "name", "type", "department_id", "category", "delivery_mode",
            "scheme_hours_per_week", "weekly_hours", "needs_continuous_block",
            "block_size", "max_per_day", "requires_room_type", "requires_equipment",
            "linked_group_id", "elective_group_id",
        ],
        "json": {"requires_equipment"},
        "int": {"weekly_hours", "block_size", "max_per_day", "scheme_hours_per_week"},
    ...
    "Teachers": {
        ...
        "required": {"id", "name"},
        "columns": [
            "id", "name", "department_id", "max_continuous_classes", "max_daily_classes",
            "max_weekly_hours", "availability", "preferred_slots", "is_guest_from_other_dept",
        ],
    ...
    "Rooms": {
        ...
        "required": {"id", "name", "type"},
        "columns": [
            "id", "name", "type", "capacity", "equipment", "department_id",
